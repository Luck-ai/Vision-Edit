...
public class ImageCanvas : Control
{
    ...
    protected override void OnPointerWheelChanged(PointerWheelEventArgs e)
    {
        ...
        var relativeMousePos = (mousePos - _panOffset) / oldZoom;
        _panOffset = mousePos - relativeMousePos * _zoom;
    ...
    protected override void OnPointerMoved(PointerEventArgs e)
    {
        ...
        {
            var delta = (pos - _lastMousePos) / _zoom * (OriginalImage.Size.Width / imgRect.Width * _zoom);
            // This delta calculation is a bit tricky due to letterboxing.
            // Simpler way:
